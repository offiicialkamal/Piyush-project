...
def extract_params_from_page():
    ...
    # Use your cookies for the session
    ...
    # Extract fb_dtsg (often in a meta tag or in JavaScript)
...
def make_graphql_request(params, cookies):
    headers = {
        'accept': '*/*',
        'accept-language': 'en-IN,en-GB;q=0.9,en-US;q=0.8,en;q=0.7,mr;q=0.6',
...
try:
    ...
    params, fresh_cookies = extract_params_from_page()
    ...
    if params:
        ...
        response = make_graphql_request(params, fresh_cookies)
